...
You can see auto generated json-schema [IReqPokeDetail](https://github.com/maeumjs/maeum/blob/main/src/schema/v1/poke-detail/IReqPokeDetail.ts) and [IPokemon](https://github.com/maeumjs/maeum/blob/main/src/schema/v1/poke-detail/IPokemon.ts).

## Swagger.io
Same mechanics validation.

## Test
Test using fastify.js e2e test function(= inject). You can see example [name.test.ts](https://github.com/maeumjs/maeum/blob/main/src/handler/get/v1/poke-detail/__tests__/name.test.ts)
...
You have to do implement business logic like [that](https://github.com/maeumjs/maeum/blob/main/src/module/v1/readPokeDetailByName.ts).

## Response JSON serialization function
You have to do implement business logic like [that](https://github.com/maeumjs/maeum/blob/main/src/serializer/v1/serializerPokemonToWithTid.ts)
